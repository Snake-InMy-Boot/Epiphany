...
//intro animation
const unlock = document.querySelector("html");
...
if (!sessionStorage.getItem('hasVisited')) {
  ...
  tl.fromTo(".arrow-down", {opacity: 0, }, {opacity: 1, duration: 1},"-=1");
  ...
  tl.fromTo("#big-text", {opacity: 0, }, {opacity: 1, duration: 0.75});
  tl.fromTo(".arrow-down", {opacity: 0, }, {opacity: 1, duration: 0.75}, "-=.75");
